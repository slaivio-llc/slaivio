...
export function PilotInboxPage() {
  ...
  return <div className="flex min-h-0 flex-col bg-white text-[#25292e] lg:h-[calc(100vh-64px)]">
    <OperationPageHeader title={dashboardLabel(locale,"Boîte de réception")} description={dashboardLabel(locale,"Conversations WhatsApp, clients et dossiers réunis dans un espace de travail simple.")} backHref="/app/communication" backLabel="Retour à la communication" actions={aiSettings && <AIModeControl settings={aiSettings} change={changeAgencyMode} />} />
